...
public class DragonManager : MonoBehaviour
{
    ...
    void Start()
    {
       // _destination = GameObject.FindWithTag("Civil");
   ...
   //*********************************  /////////////////////////////////////
    ...
    private void CalculCivilProche()
    {
        ...
        if(tableauDestination.Count == 0) {
            ...
            tableauDestination.Add(GameObject.Find("PlayerCapsule").gameObject);
            GameObject.Find("PlayerCapsule").gameObject.tag = "Civil";
            _destination = GameObject.Find("PlayerCapsule").gameObject;
